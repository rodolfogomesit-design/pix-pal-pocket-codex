...
import { ArrowRight, Sparkles, Star, WalletCards } from "lucide-react";
...
const HeroSection = () => {
  return (
    <section className="relative overflow-hidden pb-24 pt-28 md:pb-32 md:pt-32">
          ...
          <div className="relative overflow-hidden rounded-[34px] border border-white/50 bg-white/80 shadow-[0_30px_90px_-30px_rgba(15,23,42,0.28)] backdrop-blur dark:border-white/10 dark:bg-slate-950/70 dark:shadow-[0_30px_90px_-30px_rgba(0,0,0,0.75)]">
            <div className="border-b border-white/40 bg-[linear-gradient(90deg,rgba(251,191,36,0.22),rgba(255,255,255,0.55),rgba(56,189,248,0.22),rgba(168,85,247,0.18))] px-6 py-4 dark:border-white/10 dark:bg-[linear-gradient(90deg,rgba(251,191,36,0.08),rgba(30,41,59,0.58),rgba(56,189,248,0.12),rgba(168,85,247,0.1))]">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-extrabold uppercase tracking-[0.18em] text-transparent bg-[linear-gradient(135deg,#fb7185,#f59e0b,#22c55e,#38bdf8,#8b5cf6)] bg-clip-text">
                    Painel da família
                  </p>
                </div>
...
const LoginButton = () => {
  return (
    <Button
      ...
      size="lg"
      variant="outline"
      className="h-14 rounded-full border-slate-300/70 bg-white/90 px-8 text-base font-bold text-slate-900 shadow-sm backdrop-blur hover:bg-white dark:border-white/10 dark:bg-slate-950/60 dark:text-white dark:hover:bg-slate-900"
    >
      <Link to="/login">
