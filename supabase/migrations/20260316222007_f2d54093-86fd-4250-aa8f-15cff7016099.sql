-- Update register_referral to use codigo_publico instead of referral_code
...
BEGIN
  SELECT * INTO _kid FROM kids_profiles WHERE codigo_publico = _referral_code AND is_mini_gerente = true;
  IF NOT FOUND THEN
...
-- Update kid_register_referral to use codigo_publico instead of referral_code
