...
-- Update kid_transfer_with_pin to always approve (remove approval logic)
...
-- Update kid_request_pix_payment to execute directly (no approval needed)
...
BEGIN
  ...
  -- Record the pix request as completed
